...
UPDATE ps_configuration t SET t.value = 
'https://pprod-papi-gateway.back.defense.gouv.fr/in/prestations-equipement/mediateur-habillement/v4/api/commandes' WHERE t.name = "EGGATEWAY_MEDIATOR_ORDER_ENDPOINT_URL";
